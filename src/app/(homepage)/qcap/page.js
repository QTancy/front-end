      ...
      <div className="w-full max-w-3xl flex flex-col gap-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex space-x-2">
            <button className="custom-button-primary px-4 py-2 rounded-md text-sm font-semibold">
              Cancel
            </button>
            <button className="custom-button-secondary px-4 py-2 rounded-md text-sm font-semibold">
              Analyst
            </button>
          </div>
        </div>
        ...
        <div className="text-center">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold mt-2">
            What is Your New Receipt?
          </h2>
          <p className="text-sm mt-2 color-text-on-background">
            Upload your media or choose take a photo. The first photo will be
            thumbnail in your history. Drag or snap up to 3 image to create
            multiple receipt in one history
          </p>
        </div>
        ...
        <div className="border border-gray-400 rounded-xl py-10 flex flex-col items-center space-y-4 text-center bg-white">
          ...
          <p className="text-sm text-gray-500">
            Photos must be less than <span className="font-bold">10 MB</span> in
            size
          </p>

          <div className="flex space-x-4 mt-2">
            <button className="px-4 py-2 rounded-full custom-button-primary font-semibold">
              Take a photo
            </button>
            <button className="px-4 py-2 rounded-full custom-button-secondary font-semibold">
              Upload
            </button>
          </div>
        </div>
