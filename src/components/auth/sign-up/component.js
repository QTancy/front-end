...
import { AppLogo, FacebookLogo, GoogleLogo, SignInIllustration, SignUpIllustration, TwitterLogo } from "@/icons";
        ...
        <div className="w-full flex justify-center gap-72">
            ...
            <div className="max-w-[400px] flex flex-col items-center justify-center p-4 rounded-3xl sign-form drop-shadow-xl shadow-xl">
                ...
                <div className="w-full flex text-center items-center">
                    <p className="text-sm">By Clicking continue, you agree to our <a className="link-in-sign-form">Terms of Services</a> and <a className="link-in-sign-form">Privacy Polices</a></p>
                </div>
            </div>
