  ...
  return (
    <div className="flex flex-row items-center justify-between w-full gap-16">
      ...
      <div className="flex flex-col color-text-primary">
        ...
        <ButtonLink
          icon={CallPrimaryLogo}
          alt={'Call Logo'}
          text={'089232142124'}
        />
        <ButtonLink
          icon={EmailPrimaryLogo}
          alt={'Email Logo'}
          text={'qtancy@gmail.com'}
        />
        <ButtonLink
          icon={LocationPrimaryLogo}
          alt={'Location Logo'}
          text={'Sudirman Street Jakarta, Indonesia'}
        />
      </div>
      <div className="flex flex-col color-text-primary">
